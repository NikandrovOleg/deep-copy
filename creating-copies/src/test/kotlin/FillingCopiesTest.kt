...
class FillingCopiesTest {
    ...
    fun fillingEmptyGraph() {
        ...
        assertThat(graph.vertices.all { it.copy != null }, `is`(true))
    }
    ...
    fun fillingGraphWithOneNullVertex() {
        ...
        fillingCopies.fill(graph)
        assertThat(graph.vertices.filter { it::class.isSubclassOf(ComplexVertex::class) }.all { it.copy != null },
            `is`(true))
    }
    ...
    fun fillingGraphWithOneComplexClass() {
        ...
        val stringVertex = PrimitiveVertexImpl(String::class, "string")
